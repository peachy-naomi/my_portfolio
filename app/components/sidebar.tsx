    ...
    <>
      ...
      <div className="md:hidden w-full flex justify-between items-center px-4 py-3 bg-[var(--portfolio-bg)] border-b border-[var(--portfolio-surface-soft)] shadow-sm z-30 fixed">
        <button
          ...
          className="flex-shrink-0 w-9 h-9 aspect-square flex items-center justify-center rounded-full bg-[var(--portfolio-surface)] border border-[var(--portfolio-surface-soft)] text-[var(--portfolio-text)] hover:border-[var(--portfolio-primary-purple)] hover:text-[var(--portfolio-primary-purple)] transition-all duration-200"
        >
